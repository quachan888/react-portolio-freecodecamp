        ...
        <section id="projects" className="text-gray-400 bg-gray-900 body-font">
            <div className="container px-5 py-10 mx-auto text-center lg:px-40">
                <div className="flex flex-col w-full mb-20">
                    ...
                    <p className="lg-w-2/3 mx-auto leading-relaxed text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni, ipsam, corporis tenetur aperiam ut quia exercitationem doloribus quidem hic, nulla velit eligendi maiores at. Illo eligendi debitis ipsam sequi error.</p>
                </div>
