    ...
    return (
        <section id="skills">
            <div className="container px-5 py-10 mx-auto">
                ...
                <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati pariatur ipsa adipisci accusantium est fugiat debitis deleniti aliquam aut repellendus, eius necessitatibus velit, ratione nisi impedit repudiandae exercitationem neque consequatur!</p>
            </div>
